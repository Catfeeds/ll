...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('Appversion/add');?>">编辑APP版本</a></li>
		</ul>
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Appversion/edit_post');?>">
		<input type="hidden" name="id" value="<?php echo ($id); ?>">
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea rows="5" cols="5" name="content"><?php echo ($content); ?></textarea>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<select name="force">
							<option value="0" <?php if(0 == $force): ?>selected<?php endif; ?> >否</option>
							<option value="1" <?php if(1 == $force): ?>selected<?php endif; ?>>是</option>
						</select>
					</div>
				</div>
			</fieldset>
