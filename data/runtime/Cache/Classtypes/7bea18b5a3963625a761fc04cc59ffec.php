...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			<li><a href="<?php echo U('Classroom/classroomlist');?>">教室列表</a></li>
			<li><a href="<?php echo U('Classroom/add');?>">新增教室</a></li>
			<li class="active"><a href="<?php echo U('Classroom/edit',array('edit_id'=>$id));?>">编辑教室</a></li>
		</ul>
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Classroom/edit_post');?>">
