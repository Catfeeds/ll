...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('Classtype/classtypelist');?>">班级类型列表</a></li>
			<li><a href="<?php echo U('Classtype/addclasstype');?>">新增班级类型</a></li>
		</ul>
		<form class="well form-search" method="get" action="<?php echo U('Classtype/classtypelist');?>" id="form_submit">
		    <div class="search_type cc mb10">
		      <div class="mb10"> 
		        <span class="mr20">
		        <input type="hidden" name="g" value="Classtypes">
		        <input type="hidden" name="m" value="Classtype">
		        <input type="hidden" name="a" value="classtypelist">
			        ...
			        <div class="row" style="margin-top: 20px;">
				        ...
				        <div class="span2">
				        	<input type="text" name="title" style="width: 100px;" value="<?php echo ($title); ?>" placeholder="班级类型"/>
				        </div>
				        <div class="span9">
				        	&nbsp;
						</div>
		  ...
		  <form class="js-ajax-form" action="<?php echo U('Classtype/listorders');?>" method="post">
		...
		<table class="table table-hover table-bordered">
			...
			<tbody>
				<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
						...
						<td>
							<a href="<?php echo U('Classtype/editclasstype',array('editid'=>$v[id]));?>"><?php echo L('EDIT');?></a>|
							<a class="js-ajax-delete" href="<?php echo U('Classtype/deleteclasstype',array('id'=>$v[id]));?>"><?php echo L('DELETE');?></a>
						</td>
