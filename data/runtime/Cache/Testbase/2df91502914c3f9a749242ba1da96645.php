...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('Course/topicsetlist');?>">题集列表</a></li>
			<li><a href="<?php echo U('Course/addtopicset');?>">新集难度</a></li>
		</ul>
		<form class="well form-search" method="get" action="<?php echo U('Course/topicsetlist');?>" id="form_submit">
		      ...
		      <div class="mb10"> 
		        ...
		        <input type="hidden" name="a" value="topicsetlist">
			        ...
			        <div class="row" style="margin-top: 20px;">
				        ...
				        <div class="span2">
				        	<input type="text" name="title" style="width: 100px;" value="<?php echo ($title); ?>" placeholder="题集"/>
				        </div>
				        <div class="span9">
		  ...
		  <form class="js-ajax-form" action="<?php echo U('Course/topicsetlistorders');?>" method="post">
		...
		<table class="table table-hover table-bordered">
			...
			<tbody>
				<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
						...
						<td>
							<a href="<?php echo U('Course/edittopicset',array('editid'=>$v[id]));?>"><?php echo L('EDIT');?></a>|
							<a class="js-ajax-delete" href="<?php echo U('Course/deletetopicset',array('id'=>$v[id]));?>"><?php echo L('DELETE');?></a>
						</td>
