...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('Course/Questiondifflist');?>">题难度列表</a></li>
			<li><a href="<?php echo U('Course/addQuestiondiff');?>">新增题难度</a></li>
		</ul>
		<form class="well form-search" method="get" action="<?php echo U('Course/Questiondifflist');?>" id="form_submit">
		    <div class="search_type cc mb10">
		      <div class="mb10"> 
		        <span class="mr20">
		        <input type="hidden" name="g" value="Testbase">
		        <input type="hidden" name="m" value="Course">
		        <input type="hidden" name="a" value="Questiondifflist">
			        ...
			        <div class="row" style="margin-top: 20px;">
				        ...
				        <div class="span2">
				        	<input type="text" name="title" style="width: 100px;" value="<?php echo ($title); ?>" placeholder="题难度名称"/>
				        </div>
				        <div class="span9">
		  ...
		  <form class="js-ajax-form" action="<?php echo U('Course/Questiondifflistorders');?>" method="post">
		...
		<table class="table table-hover table-bordered">
			...
			<tbody>
				<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
						...
						<td>
							<a href="<?php echo U('Course/editQuestiondiff',array('editid'=>$v[id]));?>"><?php echo L('EDIT');?></a>|
							<a class="js-ajax-delete" href="<?php echo U('Course/deleteQuestiondiff',array('id'=>$v[id]));?>"><?php echo L('DELETE');?></a>
						</td>
