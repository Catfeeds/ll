...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('information/index');?>"><?php echo L('ADMIN_INFO_INDEX');?></a></li>
			<li><a href="<?php echo U('information/add');?>"><?php echo L('ADMIN_INFO_ADD');?></a></li>
		</ul>
		<table class="table table-hover table-bordered">
			...
			<tbody>
				<?php if(is_array($list)): foreach($list as $key=>$list): ?><tr>
						...
						<td><?php if(!empty($list[icon])): ?><img src="/ll/data/upload/avatar/<?php echo ($list["icon"]); ?>" style="width:50px;height:50px;"/><?php endif; ?></td>
						<td><?php echo ($list["createtime"]); ?></td>
						<td><a href="<?php echo U('information/add',array('id'=>$list[id]));?>"><?php echo L('EDIT');?></a></td>
