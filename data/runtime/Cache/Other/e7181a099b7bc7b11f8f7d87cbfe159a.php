...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('EncourageConfig/add');?>">新增积分奖励配置列表</a></li>
		</ul>
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('EncourageConfig/add_post');?>">
			<fieldset>
				<div class="control-group">
					<label class="control-label">类型</label>
					<div class="controls">
						<select name="type">
							<option value="0">认证成功</option>
							<option value="1">推荐好友</option>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="number" name="integral">
					</div>
				</div>
				<div class="control-group">
