...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			<li><a href="<?php echo U('scorecharge/scorechargelist');?>"><?php echo L('ADMIN_H5_INDEX');?></a></li>
			<li class="active"><a href="<?php echo U('scorecharge/addscore');?>"><?php echo L('ADMIN_H5_ADD');?></a></li>
		</ul>
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('scorecharge/add_post');?>">
			<fieldset>
				...
				<div class="control-group">
					<label class="control-label"><?php echo L('PRICE');?></label>
					<div class="controls">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="number" name="index_id" value="<?php echo ($index_id); ?>" required>
					</div>
				</div>
