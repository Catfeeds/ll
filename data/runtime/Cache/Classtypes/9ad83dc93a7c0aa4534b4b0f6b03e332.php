...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			<li><a href="<?php echo U('Grade/gradelist');?>">学段列表</a></li>
			<li><a href="<?php echo U('Grade/addgrade');?>">新增学段</a></li>
			<li class="active"><a href="<?php echo U('Grade/editgrade',array('edit_id'=>$id));?>">编辑学段</a></li>
		</ul>
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Grade/edit_post');?>">
