...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('Appversion/index');?>"><?php echo L('ADMIN_FEED_INDEX');?></a></li>
			<li><a href="<?php echo U('Appversion/add');?>"><?php echo L('ADMIN_FEED_ADD');?></a></li>
		</ul>
		<table class="table table-hover table-bordered" >
			...
			<tbody>
				<?php if(is_array($list)): foreach($list as $key=>$list): ?><tr>
						...
						<td><?php echo ($list["version"]); ?></td>
						<td><?php echo ($list["url"]); ?></td>
						<td><?php echo ($list["content"]); ?></td>
						<td><?php if($list[force] == 0): ?>否<?php else: ?>是<?php endif; ?></td>
						<td><?php echo ($list["createtime"]); ?></td>
						<td><a href="<?php echo U('Appversion/edit',array('editid'=>$list[id]));?>"><?php echo L('EDIT');?></a>|<a href="<?php echo U('Appversion/delete',array('id'=>$list[id]));?>" class="js-ajax-delete"><?php echo L('DELETE');?></a></td>
