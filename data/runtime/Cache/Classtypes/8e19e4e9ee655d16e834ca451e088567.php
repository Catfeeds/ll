...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('Textbook/textbooklist');?>">教科书列表</a></li>
			<li><a href="<?php echo U('Textbook/addtextbook');?>">新增教科书</a></li>
		</ul>
		<form class="well form-search" method="get" action="<?php echo U('Textbook/textbooklist');?>" id="form_submit">
		      ...
		      <div class="mb10"> 
		        ...
		        <input type="hidden" name="a" value="textbooklist">
			        ...
			        <div class="row" style="margin-top: 20px;">
				        ...
				        <div class="span2">
				        	<input type="text" name="subject" style="width: 100px;" value="<?php echo ($subject); ?>" placeholder="科目"/>
				        </div>
				        <div class="span1">
				        	出版社:
				        </div>
				        <div class="span2">
				        	<input type="text" name="press" style="width: 100px;" value="<?php echo ($press); ?>" placeholder="出版社"/>
				        </div>
				        <div class="span1">
							学段:
						</div>
						<div class="span2">
							<input type="text" name="grade1" style="width: 100px;" value="<?php echo ($grade); ?>" placeholder="学段"/>	
						</div>
		...
		<table class="table table-hover table-bordered">
			...
			<tbody>
				<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
						...
						<td>
							<a href="<?php echo U('Textbook/edittextbook',array('editid'=>$v[id]));?>"><?php echo L('EDIT');?></a>|
							<a class="js-ajax-delete" href="<?php echo U('Textbook/deletetextbook',array('id'=>$v[id]));?>"><?php echo L('DELETE');?></a>
						</td>
