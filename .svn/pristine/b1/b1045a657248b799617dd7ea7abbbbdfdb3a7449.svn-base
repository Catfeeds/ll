...
//门店
$sql = "select id, city, name, icon,details,phone,address from ecs_service where 1 = 1";
//分页算法
...
$order_address_list = $db->getAll($sql);

$val->order_address_list = $order_address_list;
