...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			<li ><a href="<?php echo U('EncourageConfig/encourageconfiglist');?>">积分奖励配置列表</a></li>
			<li><a href="<?php echo U('EncourageConfig/add');?>">新增积分奖励配置列表</a></li>
			<li class="active"><a href="<?php echo U('EncourageConfig/edit');?>">编辑积分奖励配置列表</a></li>
		</ul>
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('EncourageConfig/edit_post');?>">
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						<select name="type">
							<option value="0" <?php if(0 == $type): ?>selected<?php endif; ?> >认证成功</option>
							<option value="1" <?php if(1 == $type): ?>selected<?php endif; ?>>推荐好友</option>
							<option value="2" <?php if(2 == $type): ?>selected<?php endif; ?>>签到</option>
						</select>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<input type="number" name="integral" value="<?php echo ($integral); ?>">
					</div>
				</div>
				<div class="control-group">
			...
			<div class="form-actions">
				...
				<a class="btn" href="<?php echo U('EncourageConfig/encourageconfiglist');?>"><?php echo L('BACK');?></a>
			</div>
		</form>
	</div>
