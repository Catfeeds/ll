...
<html>
	<head>
		...
		<link href="/ll/admin/themes/lailong/Public/assets/css/admin_login.css" rel="stylesheet" />
		<style>
			#login_btn_wraper{
				text-align: center;
			}
...
<body>
	<div class="wrap">
		<h1><a href="/ll">来龙教育 <?php echo L('ADMIN_CENTER');?></a></h1>
...
var GV = {
	DIMAUB: "",
	JS_ROOT: "/ll/public/js/",//js版本号
	TOKEN : ''	//token ajax全局
};
</script>
<script src="/ll/public/js/wind.js"></script>
<script src="/ll/public/js/jquery.js"></script>
<script type="text/javascript" src="/ll/public/js/common.js"></script>
<script>
;(function(){
