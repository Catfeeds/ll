...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('Classification/addteachertype');?>">新增教师类型</a></li>
		</ul>
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Classification/addteachertype_post');?>">
			<fieldset>
