...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			<li ><a href="<?php echo U('Subject/subjectlist');?>">科目列表</a></li>
			<li><a href="<?php echo U('Subject/addsubject');?>">新增科目</a></li>
			<li class="active"><a href="<?php echo U('Subject/editsubject',array('edit_id'=>$id));?>">编辑科目</a></li>
		</ul>
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Subject/edit_post');?>">
			...
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="sort" value="<?php echo ($sort); ?>" required>
					</div>
				</div>
